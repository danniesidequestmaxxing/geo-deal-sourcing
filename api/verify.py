...
3. **Phone validation** — is the phone number a structurally valid Malaysian
   number?
"""
...
def _check_phone(phone: str) -> dict[str, Any]:
    """Validate a phone number as a structurally valid Malaysian number.
...
def _normalise_name(name: str) -> str:
    """Strip common Malaysian suffixes for fuzzy name matching.
    ...
    for suffix in ["sdn bhd", "sdn. bhd.", "sdn bhd.", "bhd", "bhd.", "(m)", "(malaysia)"]:
